...
$conn->query("INSERT IGNORE INTO `menus` VALUES
  ('nam-khon','ก๋วยเตี๋ยวน้ำข้น','(เนื้อวัว / น่องไก่) +ลูกชิ้น',50,'🍜',1,1,0),
  ('haeng','ก๋วยเตี๋ยวแห้ง','(เนื้อวัว / น่องไก่) +ลูกชิ้น',50,'🥢',1,1,0),
  ('tom-yam','ก๋วยเตี๋ยวต้มยำ','(เนื้อวัว / น่องไก่)',60,'🌶️',1,1,0),
  ('tom-yam-seafood','ก๋วยเตี๋ยวต้มยำ ทะเล','กุ้ง + หมึก',95,'🦐',1,0,1),
  ('kao-lao','เกาเหลา','(เนื้อวัว / น่องไก่) +ลูกชิ้น',50,'🥣',0,1,0)");
